...
template<class T1,class T2,class T3,class T4> void deb(T1 e1,T2 e2,T3 e3,T4 e4) {
    cout<<setprecision(10)<<e1<<" "<<e2<<" "<<e3<<" "<<e4<<"\n";
}
...
double getAngle(PT o, PT a,PT b)
{
    double oa=distPoint(o,a),ob=distPoint(o,b),ab=distPoint(a,b);
    return acos((oa*oa+ob*ob-ab*ab)/(2.0*oa*ob));
}
...
int main()
{
    //Test();
    PT a,b,c;
    while(sf("%lf %lf",&a.x,&a.y)==2){
        b.input();
        c.input();
        PT o = ComputeCircleCenter(a,b,c);
//        PT o=PT(2.5,1.4455);
        pf("<a,b> = %.10f dist = %.10f angle = %.10f\n",distPoint(o,c)/sin(getAngle(o,a,b)),distPoint(o,c),180.0*getAngle(o,a,b)/PI);
        pf("<a,c> = %.10f dist = %.10f angle = %.10f\n",distPoint(o,b)/sin(getAngle(o,a,c)),distPoint(o,b),180.0*getAngle(o,a,c)/PI);
        pf("<c,b> = %.10f dist = %.10f angle = %.10f\n",distPoint(o,a)/sin(getAngle(o,c,b)),distPoint(o,a),180.0*getAngle(o,c,b)/PI);
//        pf("<a,c> = %.10f\n",distPoint(o,b)/sin(getAngle(o,a,c)));
//        pf("<b,c> = %.10f\n",distPoint(o,a)/sin(getAngle(o,c,b)));
//        o.output();
//        double mx=max(max(distPoint(a,o),distPoint(b,o)),distPoint(c,o));
//        double res=distPoint(a,o)+distPoint(b,o)+distPoint(c,o);
//
//        double mxa = max(distPoint(a,b),distPoint(a,c));
//        double resa = distPoint(a,b)+distPoint(a,c);
//
//        double mxb = max(distPoint(b,a),distPoint(b,c));
//        double resb = distPoint(b,a)+distPoint(b,c);
//
//        double mxc = max(distPoint(c,a),distPoint(c,b));
//        double resc = distPoint(c,a)+distPoint(c,b);
//
//        deb(2.0*res-mx,2.0*resa-mxa,2.0*resb-mxb,2.0*resc-mxc);
    }
    return 0;
}
